...
public class Palette extends SLogoObservable<PaletteInfo> implements PaletteInfo {
    ...
    public static final List<Color> INITIAL_COLOR = Arrays.asList(Color.WHITE, Color.BLACK, Color.AZURE, Color.BURLYWOOD,
            Color.CORAL, Color.MEDIUMSPRINGGREEN, Color.THISTLE, Color.PLUM, Color.PALEVIOLETRED);
